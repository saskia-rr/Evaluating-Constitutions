    ...
    def chat_between_agents(self, max_turns=5):
        ...
        for iteration in range(max_turns):
            ...
            while True:
                ...
                # Check if the conversation turn has ended after patient's response
                status = self.moderator.check_conversation_status(self.patient.conversation_context, self.correct_diagnosis)
                if status['concluded']:
                    if status['diagnosis_reached']:
                        if status['correct_diagnosis']:
...
def main():
    ...
    # client = OpenAI(
    # base_url = "https://integrate.api.nvidia.com/v1",
    # api_key = "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")
    ...
    patient_instructions = ExperimentRunner.load_instructions('agent_clinic_sample_patient_prompts.json')
    ...
    for key in patient_instructions:
        experiments.extend([
            {
                "name": "best_practices_detailed_patient_temp_0_5",
            ...
            {
                "name": "empathetic_patient_temp_0_5",
                "doctor": doctor_instructions["default"],
                "patient": patient_instructions[key][1],
            ...
            {
                "name": "doctor_role_patient_temp_0_5",
                "doctor": doctor_instructions["default"],
                "patient": patient_instructions[key][1],
            ...
            {
                "name": "no_constitution_patient_temp_0_5",
                "doctor": doctor_instructions["default"],
                "patient": patient_instructions[key][1],
